...
export default function About() {
  ...
  return (
    <main className="min-h-screen bg-[#0B0F19] text-white selection:bg-[#4F46E5] selection:text-white">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="w-full lg:w-1/2 grid grid-cols-2 gap-4 relative">
              ...
              <div className="col-span-1 space-y-4 pt-12">
                <div className="relative h-[250px] rounded-3xl overflow-hidden border border-white/10 glass-panel">
                ...
                <div className="relative h-[200px] rounded-3xl overflow-hidden border border-white/10 glass-panel">
              ...
              <div className="col-span-1 space-y-4">
                <div className="relative h-[300px] rounded-3xl overflow-hidden border border-white/10 glass-panel">
                ...
                <div className="glass-panel p-6 rounded-3xl border border-white/10 bg-gradient-to-br from-[#4F46E5]/20 to-transparent flex flex-col justify-center items-center text-center h-[150px]">
                  <h3 className="text-4xl font-black text-white">6+</h3>
                  <p className="text-sm text-[#94A3B8] font-bold uppercase tracking-wider">Years Exp.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="w-full lg:w-1/2">
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-6 w-fit">
              ...
              <div className="space-y-6 text-[#94A3B8] text-base md:text-lg font-light leading-relaxed mb-10">
                <p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                <div className="glass-panel p-6 border-l-4 border-l-[#4F46E5]">
                  <h4 className="text-2xl md:text-3xl font-black text-white mb-2">1,143+</h4>
                  <p className="text-xs md:text-sm font-bold text-[#94A3B8] uppercase tracking-wider">Shipments Delivered</p>
                </div>
                <div className="glass-panel p-6 border-l-4 border-l-[#FF6B6B]">
                  <h4 className="text-2xl md:text-3xl font-black text-white mb-2">100%</h4>
                  <p className="text-xs md:text-sm font-bold text-[#94A3B8] uppercase tracking-wider">Client Satisfaction</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="py-24 bg-[#111827] relative border-y border-white/5 overflow-hidden">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-[#94A3B8] font-light">At Prime Link Global Services, we follow a streamlined, transparent, and efficient process.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="glass-panel overflow-hidden group border border-white/10"
              >
                ...
                <div className="p-6 md:p-8 relative -mt-10 md:-mt-12">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-[#0B0F19] border border-white/20 flex items-center justify-center mb-6 text-[#4F46E5] group-hover:text-[#FF6B6B] transition-colors">
                    {srv.icon}
                  </div>
                  <h4 className="text-xl md:text-2xl font-bold mb-4">{srv.title}</h4>
                  <a href="/services" className="text-[#4F46E5] font-semibold text-xs md:text-sm uppercase tracking-wider hover:text-white transition-colors">Learn More &rarr;</a>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-[#94A3B8] font-light">The architects behind our streamlined, transparent, and efficient global operations.</p>
          </motion.div>
          ...
          >
            {[
              ...
              { name: "Mohan Raj", role: "Freight Forwarding", img: "mohan.jpeg", pos: "center top" },
              ...
              <motion.div key={idx} variants={fadeUp} className="group cursor-pointer">
                <div className="relative h-72 w-full rounded-3xl overflow-hidden mb-6 border border-white/10 glass-panel">
                  <Image
