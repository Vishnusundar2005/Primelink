  ...
  return (
    <main className="min-h-screen selection:bg-[#4F46E5] selection:text-white" style={{ background: "var(--pl-bg)", color: "var(--pl-text-body)" }}>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-16 overflow-hidden">
        <SectionBackground imageUrl="/images/smartliving.jpg" overlayOpacity={70} priority={true} objectPosition="center" />
            ...
            {[
              ...
              >
                <Image
                  ...
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover object-center transition-transform duration-700 group-hover:scale-110 opacity-40 group-hover:opacity-60"
                />
      ...
      {/* Final CTA */}
      <section className="py-24 relative overflow-hidden">
        <SectionBackground imageUrl="/images/livingroom.jpg" overlayOpacity={75} objectPosition="center" />
