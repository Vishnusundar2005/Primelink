  ...
  return (
    <main className="min-h-screen selection:bg-[#4F46E5] selection:text-white" style={{ background: "var(--pl-bg)", color: "var(--pl-text-body)" }}>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-16 overflow-hidden">
        <SectionBackground imageUrl="/images/smartliving.jpg" overlayOpacity={70} />
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Automation Card */}
                <motion.div variants={fadeUp} className="relative bg-theme-alt backdrop-blur-xl rounded-3xl p-8 border-theme hover:border-[#4F46E5]/40 transition-all group overflow-hidden min-h-[220px] flex flex-col justify-between">
                  <div className="relative z-20">
                    <h6 className="text-xs font-black text-heading uppercase tracking-[0.2em] mb-3">Intelligent <br/>Automation</h6>
                    <p className="text-body text-[11px] leading-relaxed pr-4">Seamless control over lighting, climate, security, and entertainment.</p>
                  </div>
                  {/* Floorplan Visual */}
                  ...
                  <Image 
                    ...
                    className="object-cover opacity-10 group-hover:opacity-20 group-hover:scale-110 transition-all duration-700 pointer-events-none" 
                  />
                </motion.div>
                ...
                <motion.div variants={fadeUp} className="relative bg-theme-alt backdrop-blur-xl rounded-3xl p-8 border-theme hover:border-[#4F46E5]/40 transition-all group overflow-hidden min-h-[220px] flex flex-col justify-between">
                  <div className="relative z-20">
                    <h6 className="text-xs font-black text-heading uppercase tracking-[0.2em] mb-3">Curated <br/>Interiors</h6>
                    <p className="text-body text-[11px] leading-relaxed pr-4">Bespoke interior selections from world's prestigious brands.</p>
                  </div>
                ...
                <motion.div variants={fadeUp} className="relative bg-theme-alt backdrop-blur-xl rounded-3xl p-8 border-theme hover:border-[#4F46E5]/40 transition-all group overflow-hidden min-h-[220px] flex flex-col justify-between">
                  <div className="relative z-20">
                    <h6 className="text-xs font-black text-heading uppercase tracking-[0.2em] mb-3">AI-Powered <br/>Experience</h6>
                    <p className="text-body text-[11px] leading-relaxed pr-4">Adaptive intelligence that learns your lifestyle and elevates living.</p>
                  </div>
                  {/* Glowing AI Orb */}
            ...
            >
               <div className="relative h-[500px] md:h-[600px] rounded-[40px] overflow-hidden border-white/20 border shadow-3xl group">
                  <Image 
                    src="/images/smart.jpg" 
                    alt="Smart Living Control" 
                    fill 
                  ...
                  {/* Digital Interface Overlay Simulation */}
                  <div className="absolute top-10 right-10 w-48 h-64 bg-[#0B0F19]/80 backdrop-blur-xl rounded-3xl border border-white/20 p-4 flex flex-col justify-between z-30">
                     <div className="flex justify-between items-start">
                        <div className="text-[8px] !text-white/40 uppercase font-bold">Living Room</div>
                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                     </div>
                     <div className="text-center">
                        <div className="text-4xl font-black !text-white">22°</div>
                        <div className="text-[8px] text-[#4F46E5] uppercase font-bold mt-1">Optimal Comfort</div>
                     </div>
                     <div className="space-y-2">
                        <div className="h-1 bg-white/10 rounded-full overflow-hidden">
                           <div className="h-full w-2/3 bg-[#4F46E5]"></div>
                        </div>
                        <div className="flex justify-between text-[6px] !text-white/40 font-bold uppercase">
                           <span>Lighting</span>
                           <span>68%</span>
                        </div>
                     </div>
                  ...
                  <div className="absolute bottom-10 left-10 right-10 z-30">
                     <div className="bg-[#0B0F19]/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20">
                        <h3 className="!text-white text-xl font-black mb-2">Discover The Future <br/>Of Luxury Living</h3>
                        <p className="!text-white/60 text-[10px] leading-relaxed">We design, integrate, and deliver intelligent environments that anticipate your needs.</p>
                     </div>
                  </div>

                  {/* Purple Glow Effect */}
                  <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#4F46E5]/30 rounded-full blur-[80px]"></div>
               </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container-custom relative z-10">
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            >
              <h2 className="text-4xl md:text-7xl font-extrabold mb-8 text-heading tracking-tight">
                Build Luxury Spaces. <br />
                <span className="text-[#4F46E5]">Spend Smarter.</span>
              </h2>
              <p className="text-xl text-body font-light leading-relaxed mb-12 max-w-xl">
              ...
              <div className="flex flex-wrap gap-4 mb-16">
                ...
                <button className="btn-glass">Get Design Consultation</button>
              </div>

              <div className="flex items-center gap-6 p-6 rounded-3xl border-theme border bg-surface/50 backdrop-blur-xl w-fit">
                  <div className="flex -space-x-4">
                    {[1, 2, 3, 4].map(i => (
                      <div key={i} className="w-12 h-12 rounded-full border-2 border-theme overflow-hidden relative bg-zinc-800">
                        <Image 
                 ...
                 <div>
                    <p className="text-heading font-bold text-sm">Trusted by 250+ Homeowners</p>
                    <div className="flex items-center gap-2 mt-1">
                       ...
                       <span className="text-[10px] text-body font-bold">5.0/5 Average Rating</span>
                    </div>
                 </div>
              </div>
            </motion.div>
            ...
            <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <motion.div 
                  ...
                  className="bg-theme-alt p-8 border-theme hover:border-[#4F46E5]/40 transition-all group flex flex-col justify-between aspect-square md:aspect-auto relative overflow-hidden rounded-[32px]"
                >
                  <Image 
                    src={item.img} 
                    alt={item.title} 
                    fill 
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                    className="object-cover opacity-10 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none" 
                  />
                  <div className="relative z-10">
                    ...
                    <h4 className="text-lg font-bold text-heading mb-2">{item.title}</h4>
      ...
      <section className="py-24 relative overflow-hidden bg-theme-alt">
        <div className="container-custom relative z-10">
          <motion.div 
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold mb-8 text-heading tracking-tight">
              Premium Spaces. <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#8B5CF6]">Smarter Financial Planning.</span>
            </h2>
            <p className="text-lg text-body font-light leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="w-full lg:w-1/3 glass-panel p-10 border-theme"
            >
              <div className="text-orange-500 mb-8"><TrendingDown size={32} /></div>
              <h4 className="text-xl font-bold text-heading mb-4">Traditional <br/>Luxury Execution</h4>
              <p className="text-body text-xs mb-8 leading-relaxed">Fragmeted sourcing, inflated procurement layers, and unnecessary overspending.</p>
              <ul className="space-y-4">
                 {["Multiple vendor markups", "Unoptimized procurement", "Inconsistent planning", "Allocation inefficiencies"].map((t, i) => (
                   <li key={i} className="flex items-center gap-3 text-body text-[11px] font-medium">
            ...
            <div className="relative z-20 -my-8 lg:my-0">
               <div className="glass-panel p-10 md:p-14 border-[#4F46E5]/40 shadow-2xl text-center relative overflow-hidden group">
                  ...
                  <h3 className="text-5xl md:text-7xl font-black text-heading mb-4 tracking-tighter">30-40%</h3>
                  <p className="text-body text-[10px] font-medium max-w-[140px] mx-auto uppercase">Depending on project scope and strategy.</p>
               </div>
            </div>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="w-full lg:w-1/3 glass-panel p-10 border-[#4F46E5]/30 bg-[#4F46E5]/5"
            >
              <div className="text-[#4F46E5] mb-8"><ShieldCheck size={32} /></div>
              <h4 className="text-xl font-bold text-heading mb-4">Optimized <br/>Smart Procurement</h4>
              <p className="text-body text-xs mb-8 leading-relaxed">Strategic sourcing and coordinated execution to significantly improve efficiency.</p>
              <ul className="space-y-4">
                 {["Curated sourcing strategy", "Integrated execution planning", "Balanced allocation", "Premium design consistency"].map((t, i) => (
                   <li key={i} className="flex items-center gap-3 text-heading text-[11px] font-semibold">
          ...
          <div className="mt-20 glass-panel p-6 border-theme bg-surface/50 text-center max-w-2xl mx-auto flex items-center justify-center gap-4">
             <div className="w-10 h-10 rounded-full bg-[#4F46E5]/20 flex items-center justify-center text-[#4F46E5]"><Briefcase size={18}/></div>
             <p className="text-body text-sm font-light italic">Luxury isn't always about spending more. <span className="text-heading font-bold not-italic">It's about allocating better.</span></p>
          </div>
        </div>
      </section>
         ...
         <div className="container-custom relative z-10">
            ...
            >
               <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-extrabold text-heading tracking-tight">Everything Your <br/>Modern Home <span className="text-[#4F46E5]">Needs.</span></h2>
               </div>
               <p className="text-body max-w-sm font-light">Professionally sourced, quality-verified, and intelligently integrated for the modern homeowner.</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               {[
                 ...
                 <motion.div 
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: idx * 0.1 }}
                    className="group relative h-[400px] rounded-[32px] overflow-hidden border-theme border shadow-2xl"
                 >
                    <Image 
                      src={service.img} 
                      alt={service.title} 
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-theme via-transparent to-transparent opacity-80"></div>
                    <div className="absolute inset-0 p-10 flex flex-col justify-end">
                       <div className="w-12 h-12 rounded-2xl bg-[#4F46E5]/10 backdrop-blur-md flex items-center justify-center text-[#4F46E5] mb-6 group-hover:bg-[#4F46E5] group-hover:text-white transition-all">
                          {service.icon}
                       </div>
                       <h4 className="text-2xl font-bold text-heading mb-3">{service.title}</h4>
                       <p className="text-body text-sm font-light leading-relaxed mb-6 line-clamp-2">{service.desc}</p>
                       <div className="flex items-center gap-2 text-[#4F46E5] text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all">
      ...
      {/* Final CTA */}
      <section className="py-24 relative overflow-hidden">
        <SectionBackground imageUrl="/images/livingroom.jpg" overlayOpacity={75} />
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-on-bg-muted font-light leading-relaxed mb-16 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Link href="/contact" className="btn-glass px-12 py-5 text-base uppercase tracking-widest font-bold">Talk With Our Team</Link>
            </div>
          </motion.div>
        </div>
      </section>
