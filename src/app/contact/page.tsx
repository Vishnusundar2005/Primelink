    ...
    <main className="min-h-screen bg-[#0B0F19] text-white selection:bg-[#4F46E5] selection:text-white">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            {/* Head Office */}
            <motion.div variants={fadeUp} className="glass-panel p-8 border border-white/10 hover:border-[#4F46E5]/50 transition-colors group">
              ...
              <h4 className="text-lg font-bold text-white mb-2">Head Office</h4>
            ...
            {/* Branch Office */}
            <motion.div variants={fadeUp} className="glass-panel p-8 border border-white/10 hover:border-[#FF6B6B]/50 transition-colors group">
              ...
              <h4 className="text-lg font-bold text-white mb-2">Branch Office</h4>
              <p className="text-[#94A3B8] leading-relaxed font-light text-sm">
            ...
            {/* Phone */}
            <motion.div variants={fadeUp} className="glass-panel p-8 border border-white/10 hover:border-[#F59E0B]/50 transition-colors group">
              ...
              <h4 className="text-lg font-bold text-white mb-2">Direct Line</h4>
              <div className="flex flex-col gap-2 mt-4">
                <a href="tel:+918220625251" className="text-[#94A3B8] hover:text-white transition-colors flex items-center gap-2 font-medium">
                  +91 8220625251 <ArrowUpRight size={14} className="text-[#F59E0B]" />
                </a>
                <a href="tel:+918524014671" className="text-[#94A3B8] hover:text-white transition-colors flex items-center gap-2 font-medium">
            ...
            {/* Email */}
            <motion.div variants={fadeUp} className="glass-panel p-8 border border-white/10 hover:border-[#10B981]/50 transition-colors group">
              ...
              <h4 className="text-lg font-bold text-white mb-2">Digital Comms</h4>
              <div className="mt-4">
                <a href="mailto:Support@primelink.co.in" className="text-[#94A3B8] hover:text-white transition-colors flex items-center gap-2 font-medium break-all">
      ...
      {/* Massive Map Section */}
      <section className="relative h-[400px] md:h-[600px] w-full bg-[#111827] border-t border-white/5 grayscale hover:grayscale-0 transition-all duration-1000">
        <iframe 
          ...
          className="w-full h-full border-0 mix-blend-lighten opacity-80"
          allowFullScreen
          loading="lazy" 
          referrerPolicy="no-referrer-when-downgrade"
        ></iframe>
        <div className="absolute inset-0 bg-[#0B0F19]/20 pointer-events-none"></div>
      </section>
